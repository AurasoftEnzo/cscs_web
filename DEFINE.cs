...
//            //interpreter.RegisterFunction(Constants2.CHAIN, new ChainFunction(false));
//            //interpreter.RegisterFunction(Constants2.PARAM, new ChainFunction(true));
...
//            //interpreter.AddAction(Constants2.ASSIGNMENT, new MyAssignFunction());
//            //interpreter.AddAction(Constants2.INCREMENT, new MyAssignFunction(MyAssignFunction.MODE.INCREMENT));
//            //interpreter.AddAction(Constants2.DECREMENT, new MyAssignFunction(MyAssignFunction.MODE.DECREMENT));
//            //interpreter.AddAction(Constants2.POINTER, new MyPointerFunction());
//            //for (int i = 0; i < Constants2.OPER_ACTIONS.Length; i++)
//            //{
//            //    interpreter.AddAction(Constants2.OPER_ACTIONS[i], new MyAssignFunction());
//            //}
//        }
//    }

//    public partial class Constants2
//    {
...
//    //            m_name = Utils.GetToken(script, Constants2.TOKEN_SEPARATION);
//    //        }
//    //        m_originalName = m_name;
//    //        m_pointerAssign = m_name.StartsWith(Constants2.POINTER_REF);
//    //        var gui = CSCS_GUI.GetInstance(script);
//    //        if (m_pointerAssign)
//    //        {
//    //            m_name = m_name.Substring(Constants2.POINTER_REF.Length);
//    //        }

//    //        var origName = m_name;
//    //        int argStart = m_name.IndexOf(Constants2.START_ARRAY);
//    //        if (argStart > 0)
//    //        {
...
//    //        while (argStart > 0)
//    //        {
//    //            int argEnd = origName.IndexOf(Constants2.END_ARRAY, argStart + 1);
//    //            if (argEnd < 0)
//    //            {
//    //                break;
//    //            }
...
//    //                }
//    //            }
//    //            argStart = origName.IndexOf(Constants2.START_ARRAY, argEnd + 1);
//    //        }
...
//    //        if (argStart > 0)
//    //        {
//    //            int argEnd = m_originalName.IndexOf(Constants2.END_ARRAY, argStart + 1);
...
//    //    {
//    //        m_name = Constants2.GetRealName(varName);
...
//                {
//                    Console.WriteLine("Date range is out of limit: " + dt.ToString(format) + "\nDate is set to 0");
//                    dt = oldest;
//                }
//            }
//            if (DefType == "t")
...
//            while (script.Current != Constants2.END_STATEMENT && script.StillValid())
//            {
//                var labelName = Utils.GetToken(script, Constants2.TOKEN_SEPARATION).ToLower();
...
//                    new Variable(true) :
//                      script.Current == Constants2.END_STATEMENT ? Variable.EmptyInstance :
...
//            interpreter.RegisterFunction(Constants2.MSG, new VariableArgsFunction(true));
//            interpreter.RegisterFunction(Constants2.DEFINE, new VariableArgsFunction(true));
//            interpreter.RegisterFunction(Constants2.SET_OBJECT, new VariableArgsFunction(true));
//            interpreter.RegisterFunction(Constants2.DISPLAY_ARRAY, new VariableArgsFunction(true));
//            interpreter.RegisterFunction(Constants2.DISPLAY_ARR_SETUP, new VariableArgsFunction(false));
//            interpreter.RegisterFunction(Constants2.DISPLAY_ARR_REFRESH, new VariableArgsFunction(false));
//            interpreter.RegisterFunction(Constants2.DATA_GRID, new VariableArgsFunction(true));
//            interpreter.RegisterFunction(Constants2.ADD_COLUMN, new VariableArgsFunction(true));
//            interpreter.RegisterFunction(Constants2.DELETE_COLUMN, new VariableArgsFunction(true));
//            interpreter.RegisterFunction(Constants2.SHIFT_COLUMN, new VariableArgsFunction(true));
...
//            Constants2.FUNCT_WITH_SPACE.Add(Constants2.DEFINE);
//            Constants2.FUNCT_WITH_SPACE.Add(Constants2.DISPLAY_ARRAY);
//            Constants2.FUNCT_WITH_SPACE.Add(Constants2.DATA_GRID);
//            Constants2.FUNCT_WITH_SPACE.Add(Constants2.ADD_COLUMN);
//            Constants2.FUNCT_WITH_SPACE.Add(Constants2.DELETE_COLUMN);
//            Constants2.FUNCT_WITH_SPACE.Add(Constants2.SHIFT_COLUMN);
//            Constants2.FUNCT_WITH_SPACE.Add(Constants2.MSG);
//            Constants2.FUNCT_WITH_SPACE.Add(Constants2.SET_OBJECT);
//            Constants2.FUNCT_WITH_SPACE.Add(Constants2.SET_TEXT);

//            Constants2.FUNCT_WITH_SPACE.Add(Constants2.CHAIN);
//            Constants2.FUNCT_WITH_SPACE.Add(Constants2.PARAM);
...
//        //private void LoadCompilerConstants2Txt()
//        //{
...
//        //    //var lines = File.ReadLines(Path.Combine(curr3, "../../scripts/CompilerConstants2.txt"));
//        //    var lines = File.ReadLines(Path.Combine(curr3, "CompilerConstants2.txt"));
...
//        //    //    var onException = CustomFunction.Run(Interpreter, Constants2.ON_EXCEPTION, new Variable("Global Scope"),
...
//   //         var argsStr = Utils.GetBodyBetween(script, '\0', ')', Constants2.END_STATEMENT);
...
//   //     protected override Variable Evaluate(ParsingScript script)
//   //     {
//   //         string funcName = Utils.GetToken(script, Constants2.NEXT_OR_END_ARRAY);
//   //         var gui = CSCS_GUI.GetInstance(script);
...
//  //      protected override Variable Evaluate(ParsingScript script)
//  //      {
//  //          string widgetName = Utils.GetToken(script, Constants2.TOKEN_SEPARATION);
//  //          List<Variable> args = script.GetFunctionArgs();
//  //          Utils.CheckArgs(args.Count, 1, m_name);
//  //          var data = args[0];
//  //          var gui = CSCS_GUI.GetInstance(script);
...
//    //        if (m_paramMode)
//    //        {
//    //            var argsStr = Utils.GetBodyBetween(script, '\0', '\0', Constants2.END_STATEMENT);
//    //            if (argsStr.EndsWith(")"))
//    //            {
...
//    //                continue;
//    //            }
//    //            if (string.Equals(args[i].AsString(), Constants2.NEWRUNTIME, StringComparison.OrdinalIgnoreCase))
//    //            {
//    //                newRuntime = true;
//    //                continue;
//    //            }
//    //            canAdd = args[i].AsString().ToLower() == Constants2.WITH;
//    //            if (!canAdd)
//    //            {
...
//    //    public static string ReplaceSpaces(ParsingScript script, char replaceChar = ',', char end = Constants2.END_STATEMENT)
//    //    {
//    //        StringBuilder sb = new StringBuilder();
//    //        while (script.StillValid() && script.TryCurrent() != end)
//    //        {
//    //            var token = Utils.GetBodyBetween(script, '\0', ' ', end);
//    //            if (token.Equals(Constants2.WITH, StringComparison.OrdinalIgnoreCase) && sb.ToString().Last() == replaceChar)
//    //            {
...
//    //        script.Pointer = pos;
//    //        var token = Utils.GetToken(script, Constants2.END_SPACE_ARRAY);
//    //        script.MoveForwardIf(Constants2.SPACE);
//    //        if (script.Rest.StartsWith(Constants2.WITH + " ", StringComparison.OrdinalIgnoreCase))
//    //        {
//    //            args.Add(new Variable(Constants2.WITH));
//    //            script.Pointer += Constants2.WITH.Length + 1;
//    //        }
//    //        if (!script.StillValid() || script.Current == Constants2.END_STATEMENT)
//    //        {
//    //            return args;
//    //        }
...
//    //        bool isMain = data.StartsWith(Constants2.MAINMENU);
...
//    //        script.MoveForwardIf(Constants2.SPACE);
//    //        if (!script.FromPrev(Constants2.RETURN.Length).Contains(Constants2.RETURN))
//    //        {
//    //            script.Backward();
//    //        }
...
//    //        if (existing != null)
//    //        {
//    //            gui.Interpreter.AddGlobalOrLocalVariable(Constants2.POINTER_REF + name,
...
//    //    protected override Variable Evaluate(ParsingScript script)
//    //    {
//    //        string funcName = Utils.GetToken(script, Constants2.TOKEN_SEPARATION);
//    //        script.MoveForwardIf(',');
//    //        string callback = Utils.GetToken(script, Constants2.TOKEN_SEPARATION);
//    //        script.MoveForwardIf(',');
//    //        Gui = CSCS_GUI.GetInstance(script);
